...
@ComponentScan(basePackages = "com.google.rest") // вказує пекедж, який потрібно сканувати на предмет наявності сутностей, придатних для створення бінів – аналог рядка у файлі applicationContext.xml <context:component-scan base-package="com.google.accounting"/>
