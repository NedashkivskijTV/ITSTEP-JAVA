...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        numberAdapter.setOnItemClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TextView first = view.findViewById(R.id.tvFirst);
                TextView second = view.findViewById(R.id.tvSecond);
                Toast.makeText(MainActivity.this, first.getText() + " : " + second.getText(), Toast.LENGTH_SHORT).show();
            }
        });
