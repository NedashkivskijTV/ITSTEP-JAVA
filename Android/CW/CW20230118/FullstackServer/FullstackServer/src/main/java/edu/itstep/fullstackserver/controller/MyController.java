...
@RestController // @RestController – спеціальний контроллер, використовуваний у веб-сервисах RESTFul, и еквівалентний @Controller + @ResponseBody – (простір імен import org.springframework.web.bind.annotation.RestController;) – замість використосуваної раніше анотації @Controller
